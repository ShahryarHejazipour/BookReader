...
class BookSearchViewModel @Inject constructor(private val repository: BookRepository) : ViewModel() {
    ...
    val listOfBooks : MutableState<DataOrException<List<Item>,Boolean,Exception>> = mutableStateOf(DataOrException(
    ...
    fun searchBooks(query:String){
        viewModelScope.launch(Dispatchers.Default) {
           ...
           /* listOfBooks.value.loading = true
            listOfBooks.value.data = repository.getBooks(query)*/
